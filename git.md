...
Первым делом регистрируемся на сайте github.com. Далее устанавливаем git.

## Вариант 1.

Официальный сайт: [https://git-scm.com/download/win]

Скачиваем и устанавливаем и настраиваем: наше имя пользователя и адрес электронной почты. Откройте терминал и запустите команды:
...
При этом, вместо "My Name" указываете свое имя, а вместо "myEmail@example.com" свой e-mail.

## Вариант 2.

Скачиваем клиент [https://desktop.github.com/] и следуем его сообщениям.

# Краткий порядок работы git
...
0. Что такое удаленный репозиторий
...
Смотри [https://www.digitalocean.com/community/tutorials/how-to-use-git-integration-in-visual-studio-code-ru]
